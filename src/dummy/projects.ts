...
현재 <color>Google Play 스토어에 배포</color>되어 있으며, 디자인 및 기능 검토를 마친 후 출시 및 홍보를 진행 할 예정입니다.
<color>(2025년 6월 출시 예정)</color>`,
...
<color>WebView 앱</color>에서도 동작이 가능합니다.`,
    ...
    link: {
      ...
      playStore:
        'https://play.google.com/store/apps/details?id=com.rookeys.balancegame',
    },
  },
  {
